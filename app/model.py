...
def train_model(data: pd.DataFrame, model_type='linear'):
    ...
    """
    data = data.copy()
    # Use the features we engineered in the data_fetcher
    ...
    # Use the last row of the training set's features for demonstration
...
def predict_price(model, last_features, future_days: int = 1):
    ...
    For now, 'future_days' is ignored and we simply predict with the last row.
    
    :param model: The trained model.
    :param last_features: A 2D feature vector.
